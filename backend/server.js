...
const GOOGLE_API_KEY = "AIzaSyDAMP-wg5uq0lyhZbIuobIMUJ9qUfNHq4w"; // Replace with your Google API Key
const OPENAI_API_KEY = "sk-proj-your-openai-key"; // Replace with your OpenAI API Key
