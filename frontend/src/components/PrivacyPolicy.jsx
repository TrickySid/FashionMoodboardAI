  ...
  return (
    <>
      ...
      <div className="container-fluid mt-3">
        <h2 className="text mb-4">Privacy Policy</h2>
        ...
        <p>
          ...
          information when you use our application to analyze fashion
          preferences and receive AI-powered recommendations.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            accessories, color schemes) and emotional states detected using
        ...
        <ul>
          ...
          <li>
            Integrate with third-party platforms (e.g., Pinterest API for
            sharing and Google Cloud Vision API for photo analysis).
          </li>
        ...
        <p>
          We never sell your personal data to advertisers or other entities.
        </p>
        ...
        <p>
          ...
          Users can request deletion of their data anytime through the app's
          settings.
        </p>
        ...
        <p>
          ...
          withdraw your consent at any time by discontinuing app use or
        ...
        <p>
          We implement security measures like encryption and restricted access
          to protect your data. However, no system is 100% secure, and we
          encourage users to share data responsibly.
        </p>
